...
typedef volatile struct _Ifx_SRC_CPU
{
    ...
    unsigned char reserved_4[60];           /**< \brief 4, \internal Reserved */
} Ifx_SRC_CPU;
...
typedef volatile struct _Ifx_SRC_VADCCG
{
    ...
    unsigned char reserved_10[384];         /**< \brief 10, \internal Reserved */
} Ifx_SRC_VADCCG;
...
{
    Ifx_SRC_VADCG  G[2];                    /**< \brief 0, VADCG Service requests */
    unsigned char  reserved_20[256];        /**< \brief 20, \internal Reserved */
...
typedef volatile struct _Ifx_SRC
{
    ...
    unsigned char     reserved_540[960];    /**< \brief 540, \internal Reserved */
    ...
    unsigned char     reserved_D1C[660];    /**< \brief D1C, \internal Reserved */
    Ifx_SRC_GEVR      EVR;                  /**< \brief FB0, EVR Service requests */
    unsigned char     reserved_FB8[72];     /**< \brief FB8, \internal Reserved */
